...
public class Camera2BasicFragment extends Fragment
    ...
    */
    ...
    public static Fragment newInstance() {
        return new com.example.wedo.Camera2BasicFragment();
    }
...
//        view.findViewById(R.id.change).setOnClickListener(this);
    ...
    /**
     * Opens the camera specified by {@link com.example.wedo.Camera2BasicFragment#mCameraId}.
     */
...
//            final StorageReference mountainImagesRef = storageRef.child("images/user/profile.jpg"); //파일 경로 images/사용자 ID/
//
